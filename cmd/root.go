...
var rootCmd = &cobra.Command{
	Use:   "quote",
	Short: "Get stock and mutual fund quotes from various sources",
	Long:  `Get stock and mutual fund quotes from various sources.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".quote" (without extension).
	...
	// }
	if err := viper.ReadInConfig(); err != nil {
		fmt.Printf("Error reading config file %q: %v", viper.ConfigFileUsed(), err)
	}
}
